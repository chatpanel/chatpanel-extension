export const MEETING_INSIGHT_SECTIONS = [
  ...
  },
  {
    ...
    instruction: [
      ...
      'Return only a markdown bullet list with 4 to 8 bullets.',
      'Make each bullet 1 to 2 sentences that explain what was discussed and why it mattered.',
      'Start each bullet with a short topic label, followed by a colon, then the context.',
      'Prefer project, architecture, API, workflow, product, decision, incident, and operational concepts.',
      'Do not emit bare labels; every bullet must be understandable without reading the transcript.',
