...
const ALIAS = {
  ...
  // Two different actions, two different glyphs: a speaker reads THIS message aloud;
  // the waveform opens a voice CONVERSATION.
  speak:'volume-2', 'read-aloud':'volume-2', speaking:'volume-2',
  voice:'audio-lines', 'voice-chat':'audio-lines', waveform:'audio-lines',
