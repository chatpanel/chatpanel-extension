...
extension/js/vendor/codemirror.js
    Built by tools/build-editor.mjs (esbuild) from the @codemirror/* and @lezer/*
    packages pinned in package.json. Excluded from this archive; run the command
    above to reproduce it byte-for-byte.
