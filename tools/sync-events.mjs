...
const FILES = [
  ...
  'reach.js',
  'kernel.js', 'loop.js', 'trajectory.js', 'citations.js', 'adapters.js', 'tool-groups.js', 'search-engines.js', 'manifest.js', 'mcp-errors.js', 'meeting-analyzers.js', 'rules.js', 'router.js', 'tool-need.js', 'route-graph.js', 'sources.js', 'sources-retrieval.js', 'text-search.js', 'markdown-authoring.js', 'media-transcript.js', 'skill-vars.js', 'skill-manifest.js', 'skill-sources.js', 'skill-scan.js', 'structured.js', 'extraction.js',
  'observability.js', 'flowchart.js', 'memory.js', 'voice-intents.js', 'schedule.js', 'vault.js', 'view.js', 'widget.js', 'tags.js', 'titles.js',
];
