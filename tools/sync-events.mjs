...
const FILES = [
  ...
  'observability.js', 'flowchart.js', 'memory.js', 'voice-intents.js', 'entity.js', 'curate.js', 'knowledge.js', 'knowledge-derive.js', 'distance.js', 'schedule.js', 'vault.js', 'view.js', 'widget.js', 'tags.js', 'titles.js', 'weather.js',
];
