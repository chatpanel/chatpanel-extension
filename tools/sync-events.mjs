...
const FILES = [
  ...
  'kernel.js', 'loop.js', 'trajectory.js', 'citations.js', 'adapters.js', 'tool-groups.js', 'search-engines.js', 'manifest.js', 'mcp-errors.js', 'meeting-analyzers.js', 'rules.js', 'router.js', 'tool-need.js', 'route-graph.js', 'sources.js', 'sources-retrieval.js', 'text-search.js', 'markdown-authoring.js', 'skill-vars.js', 'skill-manifest.js', 'skill-sources.js', 'skill-scan.js', 'observability.js',
];
