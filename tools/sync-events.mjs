...
const FILES = [
  ...
  'reach.js',
  'kernel.js', 'loop.js', 'trajectory.js', 'citations.js', 'adapters.js', 'tool-groups.js', 'search-engines.js', 'manifest.js', 'mcp-errors.js', 'meeting-analyzers.js', 'meeting-shape.js', 'rules.js', 'router.js', 'model-candidates.js', 'route-strategies.js', 'voice-speaker.js', 'tool-need.js', 'route-graph.js', 'sources.js', 'sources-retrieval.js', 'text-search.js', 'markdown-authoring.js', 'media-transcript.js', 'pdf-layout.js', 'skill-vars.js', 'slash-commands.js', 'skill-manifest.js', 'skill-sources.js', 'skill-scan.js', 'structured.js', 'extraction.js',
  ...
  'tool-traits.js', 'tool-round.js', 'tool-loop-guard.js', 'turn-loop.js', 'model-health.js', 'failover.js', 'source-gate.js', 'tool-result.js', 'tool-discovery.js', 'tool-schema.js', 'recipe.js',
  ...
  'budget.js', 'team.js', 'team-plan.js', 'team-board.js', 'board-tool.js', 'team-cache.js', 'team-task.js', 'team-record.js', 'scorecard.js', 'project.js', 'project-run.js', 'job.js', 'gate.js', 'team-run.js', 'team-tool.js', 'team-trail.js',
  'team-worklog.js', 'team-subtask.js', 'team-org.js', 'team-observe.js',
  // The agent pool (A1): the cards, their engines, the engines' cards, the SCM connections.
  'engine.js', 'agent.js', 'model-ledger.js', 'scm-connection.js', 'recruit.js',
